...
interface RingDateDialog_Params {
    alarmItem?: AlarmItem;
...
export default class RingDateDialog extends ViewPU {
    ...
    setInitiallyProvidedValue(params: RingDateDialog_Params) {
    ...
    updateStateVars(params: RingDateDialog_Params) {
    }
    ...
    aboutToAppear(): void {
        ...
        this.selects = DataTypeUtils.deepCopy(this.alarmItem.ringDates) as number[];
    }
    initialRender(): void {
            ...
            this.observeComponentCreation2((elmtId, isInitialRender) => {
                if (isInitialRender) {
                    let componentCall = new CommonDialog(this, {
                        title: DetailConstant.DEFAULT_STRING_RING_DATE,
                        controller: this.controller,
                        onConfirm: () => {
                            this.selects.sort();
                            this.alarmItem.ringDates = this.selects;
                        },
                        closer: () => {
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ForEach.create();
                                const forEachItemGenFunction = _item => {
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        ...
                                        Checkbox.select(this.alarmItem.ringDates.indexOf(item) !== CommonConstants.DEFAULT_NUMBER_NEGATIVE);
                    ...
                    }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/view/Detail/dialog/RingDateDialog.ets", line: 39, col: 7 });
