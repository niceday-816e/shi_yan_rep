...
export class AlarmPage extends ViewPU {
    ...
    setInitiallyProvidedValue(params: AlarmPage_Params) {
    ...
    updateStateVars(params: AlarmPage_Params) {
    }
    ...
    initialRender(): void {
        ...
        Text.pop();
        {
            this.observeComponentCreation2((elmtId, isInitialRender) => {
                if (isInitialRender) {
                    let componentCall = new ClockArea(this, {}, undefined, elmtId, () => { }, { page: "entry/src/main/ets/pages/AlarmPage.ets", line: 48, col: 7 });
        ...
        }
        {
            this.observeComponentCreation2((elmtId, isInitialRender) => {
                if (isInitialRender) {
                    let componentCall = new AlarmList(this, { alarmItems: this.__alarmItems }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/pages/AlarmPage.ets", line: 50, col: 7 });
                    ViewPU.create(componentCall);
                    let paramsLambda = () => {
                        return {
